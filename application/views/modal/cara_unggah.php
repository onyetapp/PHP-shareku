<!-- Modal Cara Unggah -->
<div class="modal fade" id="caraUnggahModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-lg modal-notify modal-info" role="document">
				<!--Content-->
				<div class="modal-content">
					<!--Header-->
					<div class="modal-header">
						<p class="heading lead">Cara Meng-unggah / Upload File Di Shareku</p>
					...
					<div class="modal-footer">
						<a type="button" class="btn btn-info waves-effect waves-light" data-dismiss="modal">Saya Paham</a>
						<a type="button" class="btn btn-outline-info waves-effect" data-dismiss="modal">Tutup Laman</a>
					</div>
				</div>
				<!--/.Content-->
			</div>
		</div>
		<!-- End Modal Cara Unggah -->
